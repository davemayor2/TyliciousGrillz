      ...
      <Container className="relative z-20 w-full">
        ...
        <div className="max-w-[700px] text-left">
          ...
          <p className="animate-hero-item font-sans text-white/85 text-base md:text-[1.125rem] leading-[1.5] font-normal mt-6 mb-8 max-w-[620px]">
            Enjoy expertly grilled fish, prawns, croaker fish, lamb chops, chicken wings and more. Freshly prepared and delivered hot across your location.
          </p>
          ...
          <div className="animate-hero-item flex items-center gap-4 mt-8">
            ...
            {/* Secondary View Menu Button with bottom-to-top wipe hover fill animation */}
            <Link
              href="/menu"
              ref={secondaryBtnRef}
