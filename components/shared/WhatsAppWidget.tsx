  ...
  return (
    <div className="fixed bottom-6 right-6 z-[80] flex flex-col items-end gap-2">
      ...
      <button
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#20ba59] text-white rounded-full flex items-center justify-center border-2 border-[#1A0500] shadow-[4px_4px_0px_#1A0500] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[3px_3px_0px_#1A0500] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150 cursor-pointer select-none"
      >
        <svg className="w-7 h-7 fill-white text-[#25D366]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
